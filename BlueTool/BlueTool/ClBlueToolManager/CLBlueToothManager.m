...
@interface CLBlueToothManager ()<CBCentralManagerDelegate,CBPeripheralDelegate>
...
@implementation CLBlueToothManager


+(instancetype)cl_shareInstance{
    
    static CLBlueToothManager *manager = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        manager = [[CLBlueToothManager alloc]init];
    });
...
#pragma mark - 流程 扫描设备
-(void)cl_beginScanCBPeripheral:(void (^)(NSArray *))updataPeripheral{
    // 检查当前手机的蓝牙是否可用
